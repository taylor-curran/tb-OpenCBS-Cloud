...
public class BorrowingRepositoryImpl extends BaseRepository<Borrowing> implements BorrowingRepositoryCustom {
    ...
    private static final String BORROWING_PRODUCT = "borrowingProduct";
    ...
    public List<Borrowing> getAllActiveNotInPivotCurrency(LocalDateTime dateTime, Long currencyId) {
        Criteria criteria = this.getCriteria();
        criteria.createAlias("loan." + BORROWING_PRODUCT, BORROWING_PRODUCT, JoinType.LEFT_OUTER_JOIN);
        criteria.createAlias(BORROWING_PRODUCT + ".currency", "currency", JoinType.LEFT_OUTER_JOIN);
    ...
    public Page<SimplifiedBorrowing> getAll(String searchString, Pageable pageable) {
        ...
        criteria.createCriteria(BORROWING_PRODUCT, BORROWING_PRODUCT);
