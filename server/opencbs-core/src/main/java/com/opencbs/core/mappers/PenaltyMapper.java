...
public class PenaltyMapper {
    ...
    private static final String ACCOUNT_NOT_FOUND = "Not found account by [ID]=%s";
    ...
    public Penalty mapToEntity(PenaltyCreateDto penaltyDto){
        ...
        penalty.setAccrualAccount(this.accountService.getOne(penaltyDto.getAccrualAccountId())
                .orElseThrow(()->new IllegalArgumentException(String.format(ACCOUNT_NOT_FOUND, penaltyDto.getAccrualAccountId()))));
        penalty.setIncomeAccount(this.accountService.getOne(penaltyDto.getIncomeAccountId())
                .orElseThrow(()->new IllegalArgumentException(String.format(ACCOUNT_NOT_FOUND, penaltyDto.getIncomeAccountId()))));
        penalty.setWriteOffAccount(this.accountService.getOne(penaltyDto.getWriteOffAccountId())
                .orElseThrow(()->new IllegalArgumentException(String.format(ACCOUNT_NOT_FOUND, penaltyDto.getWriteOffAccountId()))));
