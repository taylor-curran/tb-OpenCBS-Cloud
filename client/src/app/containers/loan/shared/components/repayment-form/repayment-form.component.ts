...
export class RepaymentFormComponent implements OnInit, OnDestroy {
  @Output('onChangeRepaymentType') changeRepaymentType = new EventEmitter();
  @Output('onTotalEdited') totalEdited = new EventEmitter();
  @Output('onRepaymentDateEdited') repaymentDateEdited = new EventEmitter();
  @Output('onPrincipalAndPenaltyEdited') principalAndPenaltyEdited = new EventEmitter();
  @Output('onSetMaxAmount') setMaxAmount = new EventEmitter();
  @Input() maxAmount = '';
