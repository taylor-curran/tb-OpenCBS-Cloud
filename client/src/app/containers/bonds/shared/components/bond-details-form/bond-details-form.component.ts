...
export class BondDetailsFormComponent implements OnInit {
  ...
  @Output() amountRelatedFieldsChanged = new EventEmitter();
  @Output() couponRelatedFieldsChanged = new EventEmitter();
  ...
  amountRelatedFieldChanged() {
    this.amountRelatedFieldsChanged.emit(this.form.value);
  }

  couponRelatedFieldChanged() {
    this.amountRelatedFieldChanged();
    this.couponRelatedFieldsChanged.emit(this.form.value);
  }
