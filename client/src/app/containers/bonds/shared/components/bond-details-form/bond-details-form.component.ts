...
export class BondDetailsFormComponent implements OnInit {
  ...
  @Output() amountFieldChange = new EventEmitter();
  @Output() couponFieldChange = new EventEmitter();
  ...
  amountRelatedFieldChanged() {
    this.amountFieldChange.emit(this.form.value);
  }

  couponRelatedFieldChanged() {
    this.amountRelatedFieldChanged();
    this.couponFieldChange.emit(this.form.value);
  }
