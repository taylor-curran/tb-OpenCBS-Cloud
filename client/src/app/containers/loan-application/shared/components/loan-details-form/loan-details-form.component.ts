...
export class LoanDetailsFormComponent implements OnInit {
  ...
  @Output() loanProductSelectChanged = new EventEmitter();
  @Output() creditLineSelectChanged = new EventEmitter();
  @Output() payeeEditChanged = new EventEmitter();
  @Output() payeeDeleteChanged = new EventEmitter();
  @Output() payeeAddChanged = new EventEmitter();
  @Output() entryFeesClickChanged = new EventEmitter();
    ...
    if ( creditLine ) {
      this.creditLinesData.forEach(val => {
        if ( val.id === creditLine ) {
          ...
          this.creditLineSelectChanged.emit(val);
        }
      });
    } else {
  ...
  onLPSelect(loanProduct, creditLine?) {
    if ( loanProduct ) {
      ...
      this.loanProductSelectChanged.emit(loanProduct);
      ...
      this.loanProductSelectChanged.emit(null);
    }
