...
export class LoanDetailsFormComponent implements OnInit {
  ...
  @Output() loanProductSelected = new EventEmitter();
  @Output() creditLineSelected = new EventEmitter();
  @Output() payeeEdited = new EventEmitter();
  @Output() payeeDeleted = new EventEmitter();
  @Output() payeeAdded = new EventEmitter();
  @Output() entryFeesClicked = new EventEmitter();
    ...
    if ( creditLine ) {
      this.creditLinesData.forEach(val => {
        if ( val.id === creditLine ) {
          ...
          this.creditLineSelected.emit(val);
        }
      });
    } else {
  ...
  onLPSelect(loanProduct, creditLine?) {
    if ( loanProduct ) {
      ...
      this.loanProductSelected.emit(loanProduct);
      ...
      this.loanProductSelected.emit(null);
    }
