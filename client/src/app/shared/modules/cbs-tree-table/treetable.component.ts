...
export class TreeRowComponent {
  ...
  toggle(event: Event) {
    if (this.node.expanded) {
      this.treeTable.nodeCollapseChanged.emit({originalEvent: event, node: this.node});
    } else {
      this.treeTable.nodeExpandChanged.emit({originalEvent: event, node: this.node});
    }
...
export class TreeTableComponent {
  ...
  @Output() nodeExpandChanged: EventEmitter<any> = new EventEmitter();

  @Output() nodeCollapseChanged: EventEmitter<any> = new EventEmitter();
