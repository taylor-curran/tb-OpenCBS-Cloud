...
export class PicklistComponent implements OnInit, OnChanges {
  ...
  @Output() selectPicklist = new EventEmitter();
  @Output() clearPicklist = new EventEmitter();
